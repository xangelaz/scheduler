...
describe("Form", () => {
  ...
  //below test uses fireEvent.change to trigger the onChange event for the input field.
  //Instead of initializing the component with a default value, we simulate user interaction. This is more accurate.
  ...
  //test below can replace the above 2 tests.
